...
import sys
import socket
from src.core.core_mksec import *
...
# define path and set it to the MKSEC root dir
...
try:
    while 1:
       ...
       # user input: show main menu
        ...
        if operating_system == "windows" == False:
             ...
             #
                ...
                if operating_system != "windows":
                    ...
                    if spearphish_menu_choice == '3':
                        debug_msg(
                            me, "calling function 'custom_template' from 'src.core.core_mksec'", 3)
                        custom_template()
...
# handle keyboard interrupts
    ...
    print_error("[*] Control-C detected. Exiting the mksec")